...
export const Slogan = () => {
    return (
        <div className='containerA'>
            <div className='slogan'>Disfruta más de tu tiempo</div>
            <img className='img' src="https://media.istockphoto.com/photos/couple-doing-abs-exercises-on-mats-before-workout-in-gym-picture-id912630850?k=20&m=912630850&s=170667a&w=0&h=T6x88w_pbv_yxN8DgpIF0iH0XrOb8Qmxr0I7gIHyPms=" alt="pesa" />
            <div className='slogan'>Aporta mayores ingresos</div>
