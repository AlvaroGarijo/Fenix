      ...
      <div className="squareWorkouts">
        ...
        <div className="card">
          ...
          <div className="details">
            <div className="center">
              <h1>
                {" "}
                <a href="/strong">Peso Libre</a> <span> Fuerza</span>
              </h1>
              <p>...</p>
              <ul>
                <li>
                  <a href="./strongWorkout">
        ...
        <div className="card">
          ...
          <div className="details">
            <div className="center">
              <h1>
                KettleBell:<span> Funcional</span>
              </h1>
              <p>...</p>
              <ul>
                <li>
        ...
        <div className="card">
          ...
          <div className="details">
            <div className="center">
              <h1>
                Pilates<span> Cuerpo y Mente</span>
              </h1>
              <p>...</p>
              <ul>
                <li>
        ...
        <div className="card">
          ...
          <div className="details">
            <div className="center">
              <h1>
                Functional Medio:<span> Completo</span>
              </h1>
              <p>...</p>
              <ul>
                <li>
        ...
        <div className="card">
          ...
          <div className="details">
            <div className="center">
              <h1>
                Flexibilidad<span> Estiramientos</span>
              </h1>
              <p>...</p>
              <ul>
                <li>
