    ...
    return (
        <>
            ...
            <div className='cardsMultiple'>
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Juan Carlos Lara</h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Nacho Sánchez </h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Juan Pérez </h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Lola Indigo</h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Alvaro Garijo</h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Pepe García</h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
                ...
                <div className='cardOpinion'>
                    <div className='photoUser'></div>
                    <h2 className='nameOpinion'>Gema López</h2>
                    <h4 className='igUser'>@Instagram</h4>
                    <p className='opinion'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Mauris ipsum orci, sollicitudin vitae sapien vitae, tincidunt ultrices tortor.
                        Sed ac eros sed libero eleifend hendrerit. Suspendisse eu lectus risus.
